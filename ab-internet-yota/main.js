...
function main(){
    ...
    var html = AnyBalance.requestPost('https://login.yota.ru/UI/Login', {
    ...
    getParam(html, result, '__tariff', /(?:Фамилия Имя|>Name<)[\S\s]*?<div[^>]+class="value"[^>]*>([\S\s]*?)<\/div>/i, replaceTagsAndSpaces, html_entity_decode);
