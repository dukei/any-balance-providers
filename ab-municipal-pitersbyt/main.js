...
function main(){
    ...
    var auth_uid = !prefs.type || !g_lks[prefs.type] ? g_lks.pesc.auth_uid : g_lks[prefs.type].auth_uid;
...
//          'Accept-Charset': 'windows-1251,utf-8;q=0.7,*;q=0.3'
    ...
    html = AnyBalance.requestPost(baseurl + 'com.sigma.personal.client.ClientService.gwt',
        "6|0|4|" + baseurl + "gwt/personalAccount/|"+auth_uid+"|com.sigma.personal.client.ClientService|getAbonsList|1|2|3|4|0|",
        { 
          'Content-Type': 'text/x-gwt-rpc; charset=UTF-8', 
