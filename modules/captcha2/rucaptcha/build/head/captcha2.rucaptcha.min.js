'use strict';class RuCaptcha{constructor(a){this.key=a;this.baseurl="https://rucaptcha.com/"}async solveReCaptcha2(a,{url:b,userAgent:c}){a=await this.sendToRecognition({method:"userrecaptcha",googlekey:a,pageurl:b,userAgent:c});return await this.waitForResult(a)}async solveFunCaptcha(a,{userAgent:b,surl:c}){a=await this.sendToRecognition({method:"funcaptcha",publickey:a,surl:c,userAgent:b});return await this.waitForResult(a)}async sendToRecognition(a){let b=1,c;do await AnyBalance.trace("Отправка капчи на распознавание, попытка "+
