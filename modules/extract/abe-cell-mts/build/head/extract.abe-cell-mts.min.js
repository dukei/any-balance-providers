...
function keysToLowerCase(a){function b(a){var b=typeof a;return"object"!==b||null===a||"string"===b||"number"===b||"boolean"===b?!1:!0}if(!b(a))return a;for(var c=Object.keys(a),d=c.length,e;d--;){var g=c[d],f=g===(e=g.toLowerCase());if(!f||b(a[g]))a[e]=keysToLowerCase(a[g]),f||delete a[g]}return a}
function processTrafficH2O(a,b){function c(a,b){return a||b.isactive}function d(a,b){var c=0;b&&a.muia&&(c=0<a.muia.personalquota?a.muia.personalquota:a.muia.sharedquotasize);if(a.limits)for(var d=0;d<a.limits.length;d++)var e=a.limits[d].floor>a.limits[d].ceiling||isNaN(a.limits[d].ceiling)?a.limits[d].floor:a.limits[d].ceiling,c=c<e?e:c;else c="Infinity";b=b&&a.muia?c-a.muia.quantumremaining-a.muia.quotaremaining:0;return{quota:c,unavailable:b,consumed:a.value,available:c-b-a.value}}AnyBalance.trace("H2O profile: "+
JSON.stringify(a));var e=keysToLowerCase(a);b.remainders||(b.remainders={});b=b.remainders;var g="undefined"!=typeof a.h2o.p.muia&&a.h2o.p.muia.acceptor,f=e.personaltrafficextended,h=e.personaloptionextended;f?(AnyBalance.trace("найден валидный трафик"),!g&&(h.autoprolongations&&h.autoprolongations.reduce(c,!1)||h.extrapackages&&h.extrapackages.reduce(c,!1))?(sumParam(""+f.consumed,b,"remainders.traffic_used_mb",null,null,parseTrafficFromKb,aggregate_sum),sumParam(""+(f.consumed>h.quotas.basequota?
0:h.quotas.basequota-f.consumed),b,"remainders.traffic_left_mb",null,null,parseTrafficFromKb,aggregate_sum)):(sumParam(f.available+"",b,"remainders.traffic_left_mb",null,null,parseTrafficFromKb,aggregate_sum),sumParam(f.consumed+"",b,"remainders.traffic_used_mb",null,null,parseTrafficFromKb,aggregate_sum))):a.personaltrafficitem?(a=d(e.personaltrafficitem,g),AnyBalance.trace("найден невалидный трафик "+JSON.stringify(a)),sumParam(a.available+"",b,"remainders.traffic_left_mb",null,null,parseTrafficFromKb,
aggregate_sum),sumParam(a.consumed+"",b,"remainders.traffic_used_mb",null,null,parseTrafficFromKb,aggregate_sum)):AnyBalance.trace("Трафик не найден: "+JSON.stringify(e));e.personaltrafficitem&&getParam(e.personaltrafficitem.expirationtime,b,"remainders.traffic_left_till",null,null,parseDateISO)}
function processTrafficInternet(a){if(isAvailable("remainders.traffic_left_mb","remainders.traffic_used_mb","remainders.traffic_left_till")){var b=AnyBalance.requestGet("https://internet.mts.ru/",addHeaders({Referer:g_baseurl}));checkLoginState(b,{baseurl:"https://internet.mts.ru"});b=AnyBalance.requestGet("https://internet.mts.ru/sitesettings/H2OProfile.js",addHeaders({Referer:"https://internet.mts.ru/"}));b=getJsonObject(b,/_profile:(?=\s*\{)/i);processTrafficH2O(b,a)}}
