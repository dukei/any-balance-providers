...
function processCountersLK(a){var b=callNewLKApiToken("sharing/counters"),b=callNewLKApiResult(b);a.remainders||(a.remainders={});for(var c=0;c<b.counters.length;++c){var d=b.counters[c];AnyBalance.trace("Найден счетчик "+d.name+" ("+d.packageType+")");"Calling"===d.packageType?(AnyBalance.trace("Это минуты"),getParam(d.deadlineDate,a.remainders,"remainders.min_till",null,null,parseDateISO),getParam(d.usedAmount,a.remainders,"remainders.min_local"),getParam(d.totalAmount-d.usedAmount,a.remainders,
"remainders.min_left")):"Messaging"===d.packageType?(AnyBalance.trace("Это сообщения"),getParam(d.deadlineDate,a.remainders,"remainders.sms_till",null,null,parseDateISO),getParam(d.usedAmount,a.remainders,"remainders.sms_used"),getParam(d.totalAmount-d.usedAmount,a.remainders,"remainders.sms_left")):"Internet"===d.packageType?(AnyBalance.trace("Это трафик"),getParam(d.deadlineDate,a.remainders,"remainders.traffic_left_till",null,null,parseDateISO),getParam(d.usedAmount+d.unitType,a.remainders,"remainders.traffic_used_mb",
null,null,parseTraffic),getParam(d.totalAmount-d.usedAmount+d.unitType,a.remainders,"remainders.traffic_left_mb",null,null,parseTraffic)):AnyBalance.trace("Неизвестный счетчик: "+JSON.stringify(d))}}
