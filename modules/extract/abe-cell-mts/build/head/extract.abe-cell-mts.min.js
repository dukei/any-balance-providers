...
function getLKJson2(a){a=AnyBalance.requestGet("https://oauth.mts.ru/webapi-1.4/customers/@me",addHeaders({"X-Requested-With":"XMLHttpRequest",Authorization:"Bearer sso_1.0_websso_cookie"}));var b=getParam(a,null,null,/^\{[\s\S]*?\}$/i,null,getJson);if(!b){if(a=getParam(a,null,null,/<div[^>]+class="red-status"[^>]*>([\s\S]*?)<\/div>/i,replaceTagsAndSpaces))throw new AnyBalance.Error(a);throw new AnyBalance.Error("Не удалось найти Json с описанием пользователя, сайт изменен?");}for(var c={},d=0;d<
