...
a);return c}function isAnotherNumber(){var a=AnyBalance.getPreferences();return a.phone&&a.phone!=a.login}function checkLoginState(a,b){b=b&&b.baseurl||g_baseurl;var c=AnyBalance.getLastUrl();if(/checkAuthStatus|дождитесь окончания процесса авторизации/i.test(a)||/waitauth/i.test(c))AnyBalance.requestGet(b,addHeaders({Referer:AnyBalance.getLastUrl()}));else return a}
