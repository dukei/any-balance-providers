...
replaceTagsAndSpaces,parseBalance)}function isLoggedIn(a){return getParam(a,/(<meta[^>]*name="lkMonitorCheck")/i)||/js-logout/i.test(a)||/UI\/Logout/i.test(a)}
...
function loginWithPassword(){AnyBalance.trace("Entering lk...");var a=AnyBalance.getPreferences();return enterLK({login:a.login,password:a.password,baseurl:"https://online.mts.ru",url:"https://login.mts.ru/amserver/UI/Login?service=lk&goto=http%3A%2F%2Fonline.mts.ru%2F"})}
...
var b={};b.login=a.login;var c,d;try{c=enterLK({login:a.login,onlyAutomatic:!0}),a.password||(d=generatePassword()),(a.password||d)&&changePassword(void 0,a.password||d)}catch(e){AnyBalance.trace("Автоматический вход в кабинет не удался. Пробуем получить пароль через СМС"),d=getPasswordBySMS(a.login),c=enterLK({login:a.login,password:d,baseurl:"https://online.mts.ru",url:"https://login.mts.ru/amserver/UI/Login?service=lk&goto=http%3A%2F%2Fonline.mts.ru%2F"}),a.password&&a.password!=d&&changePassword(d,
a.password)}b.password=a.password||d;b.html=c;return b}function initialize(){var a=loginWithoutPassword(),b={success:!0,__initialization:!0};b.login=prefs.login;b.password=a.password;AnyBalance.setResult(b)}
