...
JSON.stringify(a));b.remainders||(b.remainders={});var e=b.remainders,g="undefined"!=typeof a.H2O.p.Muia&&a.H2O.p.Muia.Acceptor,f=a.PersonalTrafficExtended,k=a.PersonalOptionExtended;f?(AnyBalance.trace("найден валидный трафик"),!g&&(k.AutoProlongations&&k.AutoProlongations.reduce(c,!1)||k.ExtraPackages&&k.ExtraPackages.reduce(c,!1))?(sumParam(""+f.Consumed,e,"remainders.traffic_used_mb",null,null,parseTrafficFromKb,aggregate_sum),sumParam(""+(f.Consumed>k.Quotas.BaseQuota?0:k.Quotas.BaseQuota-f.Consumed),
e,"remainders.traffic_left_mb",null,null,parseTrafficFromKb,aggregate_sum)):(sumParam(f.Available+"",e,"remainders.traffic_left_mb",null,null,parseTrafficFromKb,aggregate_sum),sumParam(f.Consumed+"",e,"remainders.traffic_used_mb",null,null,parseTrafficFromKb,aggregate_sum))):a.PersonalTrafficItem?(g=d(a.PersonalTrafficItem,g),AnyBalance.trace("найден невалидный трафик "+JSON.stringify(g)),sumParam(g.available+"",e,"remainders.traffic_left_mb",null,null,parseTrafficFromKb,aggregate_sum),sumParam(g.consumed+
"",e,"remainders.traffic_used_mb",null,null,parseTrafficFromKb,aggregate_sum)):AnyBalance.trace("Трафик не найден: "+JSON.stringify(a));a.personalTrafficItem&&getParam(a.PersonalTrafficItem.ExpirationTime,e,"remainders.traffic_left_till",null,null,parseDateISO)}
