...
{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Accept-Language":"ru-RU,ru;q=0.9","Cache-Control":"max-age=0",Connection:"keep-alive","Upgrade-Insecure-Requests":"1","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Safari/537.36","If-Modified-Since":null},replaceNumber=[replaceTagsAndSpaces,/\D/g,"",/.*(\d\d\d)(\d\d\d)(\d\d)(\d\d)$/,"+7 $1 $2-$3-$4"];
function getParamByName(a,b){return getParam(a,null,null,new RegExp("name=[\"']"+b+'["\'][^>]*value=["\']([^"\']+)"',"i"))}function isInOrdinary(a){return/<div[^>]+class="main-menu"/i.test(a)}function uniq_fast(a){for(var b={},c=[],d=a.length,e=0,g=0;g<d;g++){var f=a[g];1!==b[f]&&(b[f]=1,c[e++]=f)}return c}
...
d.phone=""+b["mobile:phone"],d.license=""+b["profile:accountNumber"],d.tariff=""+b["mobile:tariff"]):(d.fio=c["profile:name"],d.phone_formatted=(""+c["mobile:phone"]).replace(/(\d\d\d)(\d\d\d)(\d\d)(\d\d)$/,"+7($1)$2-$3-$4"),d.phone=""+c["mobile:phone"],d.license=""+c["profile:accountNumber"],d.tariff=""+c["mobile:tariff"]);b=callNewLKApiToken("accountInfo/mscpBalance");b=callNewLKApiResult(b);d.balance=getParam(Math.round(100*b.amount)/100);d.balance||AnyBalance.trace("Нулевой баланс! Возможно, что-то не так! "+
