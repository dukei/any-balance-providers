...
{Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Accept-Language":"ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7","Cache-Control":"max-age=0",Connection:"keep-alive","Upgrade-Insecure-Requests":"1","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36"},replaceNumber=[replaceTagsAndSpaces,/\D/g,"",/.*(\d\d\d)(\d\d\d)(\d\d)(\d\d)$/,"+7 $1 $2-$3-$4"];
...
replaceTagsAndSpaces,parseBalance)}function isLoggedIn(a){AnyBalance.getPreferences();a=AnyBalance.requestGet("https://united-auth.ssl.mts.ru/account/is-authorized?xClientId=LK",addHeaders({Origin:"https://lk.mts.ru",Referer:"https://lk.mts.ru/"}));return"true"===a}
...
function getLKJson1(a){AnyBalance.getPreferences();a=AnyBalance.requestGet("https://lk.mts.ru/api/login/user-info",addHeaders({Referer:g_baseurl+"/","X-Login":fetchNumber(),"X-Requested-With":"XMLHttpRequest"}));var b={fio:null,phone_formatted:null,phone:null,license:null,region:null,balance:null,tariff:null},c=getJson(a).userProfile;b.fio=c.displayName||c.organization;b.phone_formatted=(""+c.login).replace(/(.*)(\d\d\d)(\d\d\d)(\d\d)(\d\d)$/,"+7($2)$3-$4-$5");b.phone=""+c.login;b.license=""+c.accountNumber;
b.region=""+c.regionTitle;var d=getParam(""+c.tariff,null,null,/(?:[\s\S]*?-\s)([\s\S]*?)(?:\s\([\s\S]*?)?$/i,replaceTagsAndSpaces);if(!b.balance){var e=callNewLKApiToken("accountInfo/balance");e=callNewLKApiResult(e);b.balance=getParam(Math.round(100*e.amount)/100)}b.balance||(b.balance=Math.round(100*c.balance)/100);b.balance||AnyBalance.trace("Нулевой баланс! Возможно, что-то не так! \n"+(e?JSON.stringify(e):a));b.phone||AnyBalance.trace("Не удаётся получить информацию о текущем пользователе. Сайт изменен?\n"+
a);(e=callNewLKApiGraphql({operationName:"GetProductsTariffInfo",variables:{screenName:"default"},query:"query GetProductsTariffInfo($screenName: String!) {\n  tariffInfo(input: {screenName: $screenName}) {\n    name\n    alias\n    tariffPricesInfo {\n      mainPrice {\n        price\n        basePrice\n        date\n        descriptionPrice\n        __typename\n      }\n      __typename\n    }\n    tariffType\n    industryCode\n    tariffManage\n    tariffPaymentType\n    tariffContent {\n      tariffButton\n      tariffSettingUrl\n      autoconvergent {\n        widgetMobile\n        hintBadge\n        badge\n        __typename\n      }\n      familyGroup {\n        addUser\n        addUserUrl\n        __typename\n      }\n      recommendedAmount {\n        title\n        amount\n        text\n        icon\n        modalSheet {\n          text\n          buttons {\n            text\n            url\n            __typename\n          }\n          __typename\n        }\n        __typename\n      }\n      tariffPdfUrl\n      __typename\n    }\n    tariffSigns {\n      key\n      value\n      __typename\n    }\n    __typename\n  }\n}"},
"GetBalanceBaseQueryInput"))&&e.tariffInfo&&e.tariffInfo.name&&(b.tariff=e.tariffInfo.name);!b.tariff&&d&&(b.tariff=d);return b}
...
b=""+d.tariff.name;if(!c.balance){var e=callNewLKApiGraphql({operationName:"GetBalanceBaseQueryInput",variables:{},query:"query GetBalanceBaseQueryInput {\n  balances {\n    nodes {\n      ... on BalanceInfo {\n        industry {\n          code\n          name\n          industryId\n          __typename\n        }\n        account {\n          idValue\n          idType\n          __typename\n        }\n        name\n        code\n        status\n        source\n        effectiveDate\n        cashbackBalanceText\n        cashbackHintText\n        remainingValue {\n          amount\n          currency\n          __typename\n        }\n        limits {\n          ... on LimitInfo {\n            bannerText\n            className\n            source\n            type\n            remainingValue {\n              amount\n              currency\n              __typename\n            }\n            __typename\n          }\n          ... on LimitError {\n            className\n            type\n            error {\n              message\n              code\n              __typename\n            }\n            __typename\n          }\n          __typename\n        }\n        __typename\n      }\n      ... on BalanceError {\n        industry {\n          code\n          name\n          industryId\n          __typename\n        }\n        account {\n          idValue\n          idType\n          __typename\n        }\n        error {\n          message\n          code\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}"},
"GetBalanceBaseQueryInput");if(e&&e.balances&&e.balances.nodes&&e.balances.nodes.length)for(d=0;d<e.balances.nodes.length;++d){var k=e.balances.nodes[d];if(k.account.idValue===fetchNumber()){c.balance=getParam(Math.round(100*k.remainingValue.amount)/100);break}}}c.balance||AnyBalance.trace("Нулевой баланс! Возможно, что-то не так! \n"+(e?JSON.stringify(e):a));c.phone||AnyBalance.trace("Не удаётся получить информацию о текущем пользователе. Сайт изменен?\n"+a);(e=callNewLKApiGraphql({operationName:"GetProductsTariffInfo",
variables:{screenName:"default"},query:"query GetProductsTariffInfo($screenName: String!) {\n  tariffInfo(input: {screenName: $screenName}) {\n    name\n    alias\n    tariffPricesInfo {\n      mainPrice {\n        price\n        basePrice\n        date\n        descriptionPrice\n        __typename\n      }\n      __typename\n    }\n    tariffType\n    industryCode\n    tariffManage\n    tariffPaymentType\n    tariffContent {\n      tariffButton\n      tariffSettingUrl\n      autoconvergent {\n        widgetMobile\n        hintBadge\n        badge\n        __typename\n      }\n      familyGroup {\n        addUser\n        addUserUrl\n        __typename\n      }\n      recommendedAmount {\n        title\n        amount\n        text\n        icon\n        modalSheet {\n          text\n          buttons {\n            text\n            url\n            __typename\n          }\n          __typename\n        }\n        __typename\n      }\n      tariffPdfUrl\n      __typename\n    }\n    tariffSigns {\n      key\n      value\n      __typename\n    }\n    __typename\n  }\n}"},
"GetBalanceBaseQueryInput"))&&e.tariffInfo&&e.tariffInfo.name&&(c.tariff=e.tariffInfo.name);!c.tariff&&b&&(c.tariff=b);return c}
...
a);c.phone||AnyBalance.trace("Не удаётся получить информацию о текущем пользователе. Сайт изменен?\n"+a);(a=callNewLKApiGraphql({operationName:"GetProductsTariffInfo",variables:{screenName:"default"},query:"query GetProductsTariffInfo($screenName: String!) {\n  tariffInfo(input: {screenName: $screenName}) {\n    name\n    alias\n    tariffPricesInfo {\n      mainPrice {\n        price\n        basePrice\n        date\n        descriptionPrice\n        __typename\n      }\n      __typename\n    }\n    tariffType\n    industryCode\n    tariffManage\n    tariffPaymentType\n    tariffContent {\n      tariffButton\n      tariffSettingUrl\n      autoconvergent {\n        widgetMobile\n        hintBadge\n        badge\n        __typename\n      }\n      familyGroup {\n        addUser\n        addUserUrl\n        __typename\n      }\n      recommendedAmount {\n        title\n        amount\n        text\n        icon\n        modalSheet {\n          text\n          buttons {\n            text\n            url\n            __typename\n          }\n          __typename\n        }\n        __typename\n      }\n      tariffPdfUrl\n      __typename\n    }\n    tariffSigns {\n      key\n      value\n      __typename\n    }\n    __typename\n  }\n}"},
"GetBalanceBaseQueryInput"))&&a.tariffInfo&&a.tariffInfo.name&&(c.tariff=a.tariffInfo.name);!c.tariff&&tarifff&&(c.tariff=tarifff);return c}
...
"GetBalanceBaseQueryInput"))&&a.tariffInfo&&a.tariffInfo.name&&(out.tariff=a.tariffInfo.name);!out.tariff&&tarifff&&(out.tariff=tarifff);return b}function isAnotherNumber(){var a=AnyBalance.getPreferences();return a.phone&&a.phone!=a.login}
...
g_baseurl+"/.",!1,!0);AnyBalance.trace(b);throw new AnyBalance.Error("Не удалось зайти в личный кабинет. Он изменился или проблемы на сайте.");}b=AnyBalance.requestGet("https://lk.mts.ru/api/login/user-info",addHeaders({Referer:g_baseurl+"/","X-Requested-With":"XMLHttpRequest"}));__setLoginSuccessful();turnOffLoginSMSNotify();return b}
...
(AnyBalance.trace("Сессия новая. Будем логиниться заново..."),b=enterLK({login:a.login,password:a.password,baseurl:"https://lk.mts.ru",url:"https://united-auth.ssl.mts.ru/account/login?goto=https://lk.mts.ru/&xClientId=LK"}));g_savedData.setCookies();g_savedData.save();return b}
...
null,null,parseTraffic,aggregate_sum),sumParam(d.totalAmount+" "+d.unitType,a.remainders,"remainders.traffic_total_mb",null,null,parseTraffic,aggregate_sum),sumParam(d.usedByAcceptors+" "+d.unitType,a.remainders,"remainders.traffic_used_by_acceptors_mb",null,null,parseTraffic,aggregate_sum),sumParam((d.currentAmount||d.totalAmount-d.usedAmount)+" "+d.unitType,a.remainders,"remainders.traffic_left_mb",null,null,parseTraffic,aggregate_sum)):AnyBalance.trace("Неизвестный счетчик: "+JSON.stringify(d))}}
function processServicesLK(a){a.services||(a.services={});var b=callNewLKApiToken("services/list/active");b=callNewLKApiResult(b);getParam({Unblocked:"Номер не блокирован",OnlyInboundCalls:"Частичная блокировка",VoluntaryBlock:"Добровольная блокировка",BlockDueToInsufficiencyOfMoney:"Номер заблокирован",Blocked:"Номер заблокирован"}[b.accountBlockStatus]||b.accountBlockStatus,a.services,"services.statuslock");getParam(0,a.services,"services.services");getParam(0,a.services,"services.services_free");
getParam(0,a.services,"services.services_paid");getParam(0,a.services,"services.services_abon");getParam(0,a.services,"services.services_abon_day");for(var c=0;c<b.services.length;++c){var d=b.services[c];/[Абонентская|Ежемесячная]* плата|Абонплата/i.test(d.name)||(sumParam(1,a.services,"services.services",null,null,parseBalanceSilent,aggregate_sum),!1!==d.isSubscriptionFee&&0!==d.primarySubscriptionFee.value||/Моб[ильная|\.]* маркировка/i.test(d.name)?!0===d.isSubscriptionFee&&0!==d.primarySubscriptionFee.value||
/Моб[ильная|\.]* маркировка/i.test(d.name)?(AnyBalance.trace("Найдена платная услуга "+d.name+": "+d.primarySubscriptionFee.quotaPeriodicity+" "+d.primarySubscriptionFee.value+" ₽"),sumParam(1,a.services,"services.services_paid",null,null,parseBalanceSilent,aggregate_sum),"Month"!==d.primarySubscriptionFee.unitOfMeasure?sumParam(d.primarySubscriptionFee.value,a.services,"services.services_abon_day",null,null,parseBalanceSilent,aggregate_sum):sumParam(d.primarySubscriptionFee.value,a.services,"services.services_abon",
null,null,parseBalanceSilent,aggregate_sum)):AnyBalance.trace("Неизвестный тип услуги: "+JSON.stringify(d)):(AnyBalance.trace("Найдена бесплатная услуга "+d.name),sumParam(1,a.services,"services.services_free",null,null,parseBalanceSilent,aggregate_sum)))}b=callNewLKApiToken("contentSubscription/list/active");if((b=callNewLKApiResult(b))&&b.length&&0<b.length)for(c=0;c<b.length;++c)d=b[c],sumParam(1,a.services,"services.services",null,null,parseBalanceSilent,aggregate_sum),0===d.cost?(AnyBalance.trace("Найдена бесплатная услуга "+
d.contentName),sumParam(1,a.services,"services.services_free",null,null,parseBalanceSilent,aggregate_sum)):(AnyBalance.trace("Найдена платная услуга "+d.contentName+": "+d.cost+" ₽"+d.costInfo),sumParam(1,a.services,"services.services_paid",null,null,parseBalanceSilent,aggregate_sum),/30 дней|1 месяц/i.test(d.costInfo)?sumParam(d.cost,a.services,"services.services_abon",null,null,parseBalanceSilent,aggregate_sum):sumParam(d.cost,a.services,"services.services_abon_day",null,null,parseBalanceSilent,
aggregate_sum));else AnyBalance.trace("Не удалось получить список дополнительных услуг. Возможно, они отсутствуют")}function getCsrfToken(){AnyBalance.requestGet("https://lk.mts.ru/api/login/refreshCsrfToken",addHeaders({Accept:"application/json, text/plain, */*",Referer:"https://lk.mts.ru/","X-Login":fetchNumber()}));var a=AnyBalance.getLastResponseHeader("X-Refresh-Csrf-Token");a?(g_savedData.setCookies(),g_savedData.save()):AnyBalance.trace("Не удалось получить csrfToken");return a}
...
(!c.phone||endsWith(e.phone,c.phone))){AnyBalance.trace("Выбран номер "+e.phone);var k=e}}if(!k)throw new AnyBalance.Error("Не удалось переключиться на номер "+c.phone+". Вероятно, он не принадлежит логину "+c.login);d=k.id;k=getCsrfToken();a=AnyBalance.requestPost("https://united-auth.ssl.mts.ru/account/switch/"+d+"?xClientId=LK",null,addHeaders({"Content-Type":"application/json",Referer:g_baseurl+"/","X-Csrf-Token":k,"X-Login":"7"+c.login}));for(d=5;!/"loginStatus":\s*?"Success"/i.test(a)&&0<d--;){a=
AnyBalance.requestGet("https://lk.mts.ru/api/login/user-info",addHeaders({Accept:"application/json, text/plain, */*","X-Login":fetchNumber(),"X-Requested-With":"XMLHttpRequest"}));if(/"loginStatus":\s*?"Success"/i.test(a))break;sleep(2E3)}if(/"loginStatus":\s*?"Success"/i.test(a))AnyBalance.trace("Успешно переключились на номер "+c.phone),a=AnyBalance.requestGet("https://lk.mts.ru/api/Access/user-verification",addHeaders({Referer:g_baseurl+"/","X-Login":"7"+c.phone})),AnyBalance.trace("Верификация пользователя: "+
a);else throw AnyBalance.trace(a),new AnyBalance.Error("Не удалось переключиться на другой номер. Сайт изменен?");}}processInfoLK(a,b);try{processCountersLK(b)}catch(f){AnyBalance.trace("Ошибка получения остатков из кабинета. Попробуйте ещё раз позднее. Ошибка: "+f.message),b.were_errors=!0}if(isAvailable("cashback"))try{var h=callNewLKApiToken("cashback/account"),g=callNewLKApiResult(h);getParam(g.balance,b,"cashback")}catch(f){AnyBalance.trace("Ошибка получения данных по кешбэку на связь: "+f.message)}if(isAvailable("credit"))try{h=
callNewLKApiToken("creditLimit"),g=callNewLKApiResult(h),getParam(g.currentCreditLimitValue,b,"credit")}catch(f){AnyBalance.trace("Ошибка получения данных по кредитному лимиту: "+f.message)}if(isAvailable("loyalty"))try{processCashbackLK(b)}catch(f){AnyBalance.trace("Ошибка получения данных по кешбэку МТС: "+f.message)}if(isAvailable("services"))try{processServicesLK(b)}catch(f){AnyBalance.trace("Ошибка получения данных по подключенным услугам: "+f.message)}isAvailable("messages")&&processMessagesLK(b);
isAvailable("expenses")&&processExpensesLK(b);isAvailable("payments")&&processTransactionsLK(b);isAvailable("tariff_abon")&&processTariffAbonLK(b)}function sleep(a){AnyBalance.trace("Sleeping "+a+" ms");AnyBalance.sleep(a)}function parseBalanceRound(a){a=parseBalance(a);isset(a)&&(a=Math.round(100*a)/100);return a}
...
function turnOffLoginSMSNotify(){var a=AnyBalance.requestGet("https://id.mts.ru/account",addHeaders({Referer:"https://login.mts.ru/"})),b=getParam(a,/\/_next\/static\/([\d\S]*?)\/_buildManifest\.js/i,replaceHtmlEntities);if(a&&b){try{a=AnyBalance.requestGet("https://id.mts.ru/_next/data/"+b+"/account/safety.json",addHeaders({Accept:"*/*",Referer:"https://id.mts.ru/account"}));var c=getJson(a)}catch(d){AnyBalance.trace("Не удалось получить страницу настроек безопасности. Пропускаем проверку способа входа и оповещения о входе");
return}c.pageProps&&c.pageProps.initialState&&c.pageProps.initialState.smsNotification&&c.pageProps.initialState.smsNotification.notifications?(a=c.pageProps.initialState.smsNotification.notifications)&&!1!==a.lg_sms?(AnyBalance.trace("SMS уведомление о входе в кабинет включено. Выключаем..."),a.lg=!1,a.lg_sms=!1,a=AnyBalance.requestPost("https://id.mts.ru/api",JSON.stringify({call:"patchSettingNotification",arg:a}),addHeaders({"Content-Type":"application/json",Referer:"https://id.mts.ru/account/safety/sms-notifications"})),
