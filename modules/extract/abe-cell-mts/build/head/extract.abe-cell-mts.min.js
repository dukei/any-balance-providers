...
getJson(c),AnyBalance.trace("Получен результат "+a.verb+" от "+b.refreshDate),b.data;AnyBalance.sleep(2E3)}throw new AnyBalance.Error("Не удалось получить результат "+a.verb);}
