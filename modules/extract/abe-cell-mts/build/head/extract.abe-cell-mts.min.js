...
b=callNewLKApiResult(b),getParam(b.balance,a.remainders,"remainders.cashback"));if(isAvailable("remainders.statuslock remainders.services remainders.services_free remainders.services_paid remainders.services_abon remainders.services_abon_day".split(" "))){b=callNewLKApiToken("services/list/active");b=callNewLKApiResult(b);getParam({Unblocked:"Номер не блокирован",OnlyInboundCalls:"Частичная блокировка",VoluntaryBlock:"Добровольная блокировка",BlockDueToInsufficiencyOfMoney:"Номер заблокирован",Blocked:"Номер заблокирован"}[b.accountBlockStatus]||
b.accountBlockStatus,a.remainders,"remainders.statuslock");getParam(b.services.length,a.remainders,"remainders.services");getParam(0,a.remainders,"remainders.services_free");getParam(0,a.remainders,"remainders.services_paid");getParam(0,a.remainders,"remainders.services_abon");getParam(0,a.remainders,"remainders.services_abon_day");for(c=0;c<b.services.length;++c)d=b.services[c],!1===d.isSubscriptionFee||0===d.primarySubscriptionFee.value?(AnyBalance.trace("Найдена бесплатная услуга "+d.name),sumParam(1,
a.remainders,"remainders.services_free",null,null,parseBalanceSilent,aggregate_sum)):!0===d.isSubscriptionFee&&0!==d.primarySubscriptionFee.value?(AnyBalance.trace("Найдена платная услуга "+d.name+": "+d.primarySubscriptionFee.quotaPeriodicity+" "+d.primarySubscriptionFee.value+" ₽"),sumParam(1,a.remainders,"remainders.services_paid",null,null,parseBalanceSilent,aggregate_sum),"Month"!==d.primarySubscriptionFee.unitOfMeasure?sumParam(d.primarySubscriptionFee.value,a.remainders,"remainders.services_abon_day",
null,null,parseBalanceSilent,aggregate_sum):sumParam(d.primarySubscriptionFee.value,a.remainders,"remainders.services_abon",null,null,parseBalanceSilent,aggregate_sum)):AnyBalance.trace("Неизвестный тип услуги: "+JSON.stringify(d));b=callNewLKApiToken("contentSubscription/list/active");if((b=callNewLKApiResult(b))&&b.length&&0<b.length)for(c=0;c<b.length;++c)d=b[c],sumParam(1,a.remainders,"remainders.services",null,null,parseBalanceSilent,aggregate_sum),0===d.cost?(AnyBalance.trace("Найдена бесплатная услуга "+
d.contentName),sumParam(1,a.remainders,"remainders.services_free",null,null,parseBalanceSilent,aggregate_sum)):(AnyBalance.trace("Найдена платная услуга "+d.contentName+": "+d.cost+" ₽"+d.costInfo),sumParam(1,a.remainders,"remainders.services_paid",null,null,parseBalanceSilent,aggregate_sum),/30 дней|1 месяц/i.test(d.costInfo)?sumParam(d.cost,a.remainders,"remainders.services_abon",null,null,parseBalanceSilent,aggregate_sum):sumParam(d.cost,a.remainders,"remainders.services_abon_day",null,null,parseBalanceSilent,
aggregate_sum));else AnyBalance.trace("Не удалось получить список дополнительных услуг. Возможно, они отсутствуют")}isAvailable("remainders.credit")&&(b=callNewLKApiToken("creditLimit"),b=callNewLKApiResult(b),getParam(b.currentCreditLimitValue,a.remainders,"remainders.credit"));isAvailable(["remainders.cashback_mts","remainders.cashback_mts_pending","remainders.cashback_mts_burning","remainders.cashback_mts_burning_date","remainders.premium_state"])&&processCashbackLK(a);isAvailable("messages.total_msg",
"messages.unread_msg")&&processMessagesLK(a);isAvailable(["expenses.traffic_used_total_mb","expenses.usedinthismonth","expenses.usedinprevmonth","expenses.abonservice","expenses.refill"])&&processExpensesLK(a);isAvailable(["payments.sum","payments.date","payments.descr"])&&processTransactionsLK(a);isAvailable("tariff_abon")&&processTariffAbonLK(a)}
