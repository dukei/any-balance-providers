...
function processTraffic(a){try{AnyBalance.trace("Пробуем получить трафик из ЛК");processTrafficLK(a);return}catch(b){AnyBalance.trace("Не удалось получить трафик из ЛК: "+b.message+"\n"+b.stack)}try{AnyBalance.trace("Пробуем получить трафик из интернет-кабинета");processTrafficInternet(a);return}catch(b){AnyBalance.trace("Не удалось получить трафик из интернет-кабинета: "+b.message+"\n"+b.stack)}a.were_errors=!0}function parseTrafficFromKb(a){return parseTraffic(a,"kb")}
function keysToLowerCase(a){var b=typeof a;if("object"!==b||null===a||"string"===b||"number"===b||"boolean"===b)return a;for(var b=Object.keys(a),c=b.length,d;c--;){var e=b[c];e!==(d=e.toLowerCase())&&(a[d]=keysToLowerCase(a[e]),delete a[e])}return a}
function processTrafficH2O(a,b){function c(a,b){return a||b.isactive}function d(a,b){var c=0;b&&a.muia&&(c=0<a.muia.personalquota?a.muia.personalquota:a.muia.sharedquotasize);if(a.limits)for(var d=0;d<a.limits.length;d++)var e=a.limits[d].floor>a.limits[d].ceiling||isNaN(a.limits[d].ceiling)?a.limits[d].floor:a.limits[d].ceiling,c=c<e?e:c;else c="Infinity";d=b&&a.muia?c-a.muia.quantumremaining-a.muia.quotaremaining:0;return{quota:c,unavailable:d,consumed:a.value,available:c-d-a.value}}AnyBalance.trace("H2O profile: "+
JSON.stringify(a));var e=keysToLowerCase(a);b.remainders||(b.remainders={});var f=b.remainders,g="undefined"!=typeof a.h2o.p.muia&&a.h2o.p.muia.acceptor,k=e.personaltrafficextended,h=e.personaloptionextended;k?(AnyBalance.trace("найден валидный трафик"),!g&&(h.autoprolongations&&h.autoprolongations.reduce(c,!1)||h.extrapackages&&h.extrapackages.reduce(c,!1))?(sumParam(""+k.consumed,f,"remainders.traffic_used_mb",null,null,parseTrafficFromKb,aggregate_sum),sumParam(""+(k.consumed>h.quotas.basequota?
0:h.quotas.basequota-k.consumed),f,"remainders.traffic_left_mb",null,null,parseTrafficFromKb,aggregate_sum)):(sumParam(k.available+"",f,"remainders.traffic_left_mb",null,null,parseTrafficFromKb,aggregate_sum),sumParam(k.consumed+"",f,"remainders.traffic_used_mb",null,null,parseTrafficFromKb,aggregate_sum))):a.personaltrafficitem?(g=d(e.personaltrafficitem,g),AnyBalance.trace("найден невалидный трафик "+JSON.stringify(g)),sumParam(g.available+"",f,"remainders.traffic_left_mb",null,null,parseTrafficFromKb,
aggregate_sum),sumParam(g.consumed+"",f,"remainders.traffic_used_mb",null,null,parseTrafficFromKb,aggregate_sum)):AnyBalance.trace("Трафик не найден: "+JSON.stringify(e));e.personaltrafficitem&&getParam(e.personaltrafficitem.expirationtime,f,"remainders.traffic_left_till",null,null,parseDateISO)}
