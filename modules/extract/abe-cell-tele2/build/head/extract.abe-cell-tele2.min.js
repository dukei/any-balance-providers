var g_headers={Connection:"keep-alive","Tele2-User-Agent":'"mytele2-app/4.10.0"; "unknown"; "Android/9"; "Build/12998710"',"X-API-Version":"3","User-Agent":"okhttp/4.2.0"},baseurl="https://api.tele2.ru/";
...
function processInfo(a){if(AnyBalance.isAvailable("info")){var b=getSubscriberId();a=a.info={};var c=AnyBalance.requestGet(baseurl+"api/subscribers/"+b+"/profile",addHeaders({Accept:"*/*","X-Requested-With":"XMLHttpRequest",Referer:baseurl}));c=getJson(c);getParam(c.data.fullName,a,"info.fio");getParam(b,a,"info.mphone");getParam(c.data.address.city+" "+c.data.address.street+" "+c.data.address.house,a,"info.address");getParam(c.data.email||void 0,a,"info.email")}};
