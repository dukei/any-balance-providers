...
var a=/(\D{0,1}\d+\D{2})(\d{2,3})/i.exec(b.login);if(!a)throw new AnyBalance.Error("Номер должен быть в формате а123вс190 либо 1234ав199, буквы русские.");var d=solveRecaptcha("Пожалуйста, докажите, что вы не робот",AnyBalance.getLastUrl(),JSON.stringify({SITEKEY:"6Lc66nwUAAAAANZvAnT-OK4f4D_xkdzw5MLtAYFL",TYPE:"V3",ACTION:"check_fines"})),a=[["regnum",a[1].toUpperCase()],["regreg",a[2]],["stsnum",b.password.toUpperCase()],["captchaWord",""],["reCaptchaToken",d]];AnyBalance.trace("Пробуем запросить информацию с данными: "+
b.login+", "+b.password);b=AnyBalance.requestPost("http://check.gibdd.ru/proxy/check/fines",a,addHeaders({"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8",Referer:"https://xn--90adear.xn--p1ai/check/fines/",Connection:"keep-alive"}));return getGibddJson(b)}
