...
d]];AnyBalance.trace("Пробуем запросить информацию с данными: "+b.login+", "+b.password);a=AnyBalance.requestPost("http://check.gibdd.ru/proxy/check/fines",a,addHeaders({"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8",Referer:"http://www.gibdd.ru/check/fines/",Connection:"keep-alive"}));return getGibddJson(a)}
