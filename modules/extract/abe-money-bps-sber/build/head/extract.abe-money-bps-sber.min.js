var g_headers={Accept:"application/json; charset=UTF-8","X-Sbol-OS":"android","X-Sbol-Version":"1.0.5","X-Sbol-Id":"",Connection:"Keep-Alive","User-Agent":"okhttp/3.6.0",Authorization:"Basic c2FsZXhzczczOnN0OF8xTWFtb24="},baseurl="https://digital.bps-sberbank.by/SBOLServer/";
...
function login(){var a=AnyBalance.getPreferences();AnyBalance.setDefaultCharset("utf-8");checkEmpty(a.login,"Введите логин!");checkEmpty(a.password,"Введите пароль!");/Bearer/i.test(g_headers.Authorization)||(g_headers["X-Sbol-Id"]=hex_md5(a.login).substr(0,16),a=apiCall("oauth/token",{client_id:a.login,client_secret:a.password,grant_type:"client_credentials"}),g_headers.Authorization="Bearer "+a.access_token,__setLoginSuccessful())}
