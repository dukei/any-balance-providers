...
function processCard(b,a){b=b.cardInfo;for(var d=0;d<b.balances.length;d++){var c=b.balances[d];getParam(c.amount,a,"cards.balance_"+c.curr.toLowerCase())}getParam(b.currency,a,["cards.currency"]);getParam(b.creditLimit,a,"cards.limit");getParam(b.blockedAmount,a,"cards.blocked");getParam(b.cardMask,a,"cards.num");getParam(b.iban,a,"cards.accnum");getParam("01."+b.expirationDates.expMonth+"."+b.expirationDates.expYear,a,"cards.till",null,replaceTagsAndSpaces,parseDate)}
