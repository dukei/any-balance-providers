var g_headers={Accept:"application/json","X-Test-UIDM":"true","X-Client-Type":"mobile","X-Client-Version":"a2.35 (672)","User-Agent":"okhttp/3.12.3",Connection:"Keep-Alive","Sec-Fetch-Mode":null,Origin:null,"Sec-Fetch-Site":null};
...
function processAccounts(a,b){if(AnyBalance.isAvailable("accounts")){a=callApi("api/v1.0/account/product/account/current/list/");AnyBalance.trace("Найдено текущих счетов: "+a.length);b.accounts=[];for(var c=0;c<a.length;c++){var d=a[c].accNum,e=a[c].accNum,f=a[c].accName+" "+a[c].balance.currency+" x"+e.substr(-4),d={__id:d,__name:f,num:e};__shouldProcess("accounts",d)&&processAccount(a[c],d);b.accounts.push(d)}}}
function processAccount(a,b){AnyBalance.trace("Обработка счета "+b.__name);getParam(a.balance.amount,b,"accounts.balance");getParam(a.balance.currency,b,["accounts.currency","accounts.balance"]);getParam(a.openDate,b,"accounts.date_start",null,null,parseDateISO);AnyBalance.isAvailable("accounts.transactions")}
