...
function processBonus(a,b){isAvailable("bonus")&&(a=b.bonus={},b=callApi("api/v1.3/card/loyalty/conditions/"),getParam(b.bonus&&b.bonus.currentAmount,a,"bonus.bonus_new_current"),getParam(b.bonus&&b.bonus.targetAmount,a,"bonus.bonus_new_target"),getParam(b.transactionsSum&&b.transactionsSum.posCategoryAmount,a,"bonus.bonus_tx_category"),getParam(b.transactionsSum&&b.transactionsSum.posTotalAmount,a,"bonus.bonus_tx_total"))}
