...
"="+encodeURIComponent("SM-G900F|samsung"));a.push(encodeURIComponent("version")+"="+encodeURIComponent("5.20.02"));a.push(encodeURIComponent("versionOS")+"="+encodeURIComponent("5.0"));a.push(encodeURIComponent("lat")+"="+encodeURIComponent("0.0"));a.push(encodeURIComponent("ireal")+"="+encodeURIComponent(g_imei));b=g_baseurl+"iapi2/"+c+"?"+a.join("&");c=AnyBalance.requestGet(b,g_headers);c=getJson(c);if("ok"!=c.st&&(AnyBalance.trace("Error getting "+b+": "+JSON.stringify(c)),d))throw new AnyBalance.Error(d+
