...
"="+encodeURIComponent("D6503|sony"));a.push(encodeURIComponent("version")+"="+encodeURIComponent("6.37.00"));a.push(encodeURIComponent("versionOS")+"="+encodeURIComponent("5.0"));a.push(encodeURIComponent("lat")+"="+encodeURIComponent("0.0"));b=g_baseurl+"iapi2/"+c+"?"+a.join("&");c=AnyBalance.requestGet(b,g_headers);clearAllCookies();c=getJson(c);if("ok"!=c.st&&(AnyBalance.trace("Error getting "+b+": "+JSON.stringify(c)),d))throw new AnyBalance.Error(d+": "+(c.err||"").replace(/:\s[^&]&/,": "),
