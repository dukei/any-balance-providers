...
function processLoans(b,a){if(isAvailable("credits")){b=AnyBalance.requestPost(baseurl+"RCLoanService",g_xml_loans,addHeaders({SOAPAction:""}));var e=getElements(b,/<return>/ig);AnyBalance.trace("Найдено кредитов: "+e.length);a.credits=[];for(var d=0;d<e.length;++d){var c=getParam(e[d],null,null,/<id>([\s\S]*?)<\/id>/i,replaceTagsAndSpaces),c={__id:c,__name:"Кредит "+c};__shouldProcess("credits",c)&&processLoan(e[d],c);a.credits.push(c)}}}
