...
function processCard(b,a){function d(b){return isAvailable(b)&&!isset(a[b])?!0:!1}getParam(b.balance,a,"cards.balance");getParam(b.currencyId,a,"cards.currency cards.balance cards.minpay cards.limit cards.totalCreditDebtAmount cards.blocked".split(" "));getParam(b.hold,a,"cards.blocked");getParam(b.type.id,a,"cards.type_code");getParam(b.type.name,a,"cards.type");getParam(b.pan,a,"cards.num");getParam(b.account.cba,a,"cards.accnum");getParam(b.expire,a,"cards.till",null,replaceTagsAndSpaces,parseDateISO);
getParam(b.status.name,a,"cards.status");getParam(b.product,a,"cards.name");getParam(b.cardholder,a,"cards.holder");getParam(1==b.main.id,a,"cards.isMain");getParam(b.open,a,"cards.dateStart",null,null,parseDateISO);getParam(b.paymentSystem.name,a,"cards.shortType");getParam(b.rate,a,"cards.rate");if("2"==b.type.id&&(isAvailable(["cards.totalCreditDebtAmount","cards.clearBalance","cards.own"])||d("cards.limit")||d("cards.minpay"))){var c=callApi("rest/account/"+b.accountId+"/statement/current?alien=false"),
e=getParam(c.creditLimit,null,null,null,replaceTagsAndSpaces,parseBalance),f=getParam(c.ownFunds,null,null,null,replaceTagsAndSpaces,parseBalance);getParam(e,a,"cards.limit");getParam(f,a,"cards.own");getParam(c.minAmount,a,"cards.minpay",null,replaceTagsAndSpaces,parseBalance);getParam(b.balance-e,a,"cards.clearBalance");getParam(c.totalDebt,a,"cards.totalCreditDebtAmount",null,replaceTagsAndSpaces,parseBalance);getParam(c.unpaidGracePeriodDue,a,"cards.gracepay",null,replaceTagsAndSpaces,parseBalance);
getParam(c.longGraceDueDate,a,"cards.gracepay_till",null,replaceTagsAndSpaces,parseDateISO)}"undefined"!=typeof processCardTransactions&&processCardTransactions(b,a)}function processAccounts(b){if(isAvailable("accounts")){var a=callApi("rest/account?alien=false");AnyBalance.trace("Найдено счетов: "+a.length);b.accounts=[];for(var d=0;d<a.length;++d){var c=a[d],c={__id:c.id,__name:c.type.name+" "+c.currencyId+" "+c.cba};__shouldProcess("accounts",c)&&processAccount(a[d],c);b.accounts.push(c)}}}
