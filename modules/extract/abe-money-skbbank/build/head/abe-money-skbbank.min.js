...
function processCard(a,c){AnyBalance.trace("Обработка карты "+c.__name);getParam(a.amount,c,"cards.amount",null,replaceTagsAndSpaces,parseBalanceSilent);getParam(a.balance,c,"cards.balance",null,replaceTagsAndSpaces,parseBalanceSilent);getParam(a.balanceLimit,c,"cards.balanceLimit",null,replaceTagsAndSpaces,parseBalanceSilent);getParam(a.currCode,c,["cards.currency","cards.balance","cards.amount","cards.balanceLimit"],null,replaceTagsAndSpaces);getParam(a.validDate+"",c,"cards.till",null,replaceTagsAndSpaces,
parseDateWord);getParam(a.holderName,c,"cards.holderName",null,replaceTagsAndSpaces);getParam(a.cardAccount+"",c,"cards.acc_num");getParam(a.cardSort,c,"cards.type",null,replaceTagsAndSpaces);isAvailable("cards.transactions")&&processCardTransactions(a,c)}
