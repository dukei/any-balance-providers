...
"$.debtAmount.value"),a,"accounts.debt");getParam(jspath1(b,"$.currentRecommendedPayment.value"),a,"accounts.recompay");getParam(jspath1(b,"$.currentMinimalPayment.value"),a,"accounts.minpay");getParam(jspath1(b,"$.duedate.milliseconds"),a,"accounts.minpaytill");getParam(jspath1(b,"$.marketingName"),a,"accounts.name");getParam(jspath1(b,"$.loyalty[0].amount"),a,"accounts.cashback");AnyBalance.isAvailable("accounts.transactions")&&processAccountsTransactions(a)}
