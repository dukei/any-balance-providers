...
function processCard(b,a,c){AnyBalance.trace("Обработка карты "+c.__name);var d=jspath1(a,"$.moneyAmount")||jspath1(a,"$.accountBalance");getParam(jspath1(d,"$.value"),c,"cards.balance");getParam(jspath1(d,"$.currency.name"),c,"cards.currency");getParam(jspath1(b,"$.expiration.milliseconds"),c,"cards.till");getParam(jspath1(b,"$.activated"),c,"cards.active");getParam(jspath1(b,"$.primary"),c,"cards.primary");getParam(jspath1(b,"$.reissued"),c,"cards.reissued");getParam(jspath1(b,"$.status"),c,"cards.status");
getParam(jspath1(b,"$.statusCode"),c,"cards.status_code");getParam(jspath1(b,"$.name"),c,"cards.name");getParam(jspath1(a,"$.externalAccountNumber"),c,"cards.accnum");AnyBalance.isAvailable("cards.transactions")&&processCardsTransactions(c)}
...
function processAccount(b,a){AnyBalance.trace("Обработка счета "+a.__name);var c=jspath1(b,"$.moneyAmount")||jspath1(b,"$.accountBalance");getParam(jspath1(c,"$.value"),a,"accounts.balance");getParam(jspath1(c,"$.currency.name"),a,"accounts.currency");getParam(jspath1(b,"$.creationDate.milliseconds"),a,"accounts.date_start");getParam(jspath1(b,"$.accountGroup"),a,"accounts.type");getParam(jspath1(b,"$.accountType"),a,"accounts.type_code");getParam(jspath1(b,"$.authorizationsAmount.value"),a,"accounts.blocked");
getParam(jspath1(b,"$.defaultMonthlyCashLimit.value"),a,"accounts.free_cash_limit");getParam(jspath1(b,"$.defaultRenewalAmountLeft.value"),a,"accounts.free_add_limit");getParam(jspath1(b,"$.monthlyCashLimit.value"),a,"accounts.free_cash_left");getParam(jspath1(b,"$.renewalAmountLeft.value"),a,"accounts.free_add_left");getParam(jspath1(b,"$.rate"),a,"accounts.pct");getParam(jspath1(b,"$.status"),a,"accounts.status_code");getParam(jspath1(b,"$.creditLimit.value"),a,"accounts.limit");getParam(jspath1(b,
"$.debtAmount.value"),a,"accounts.debt");getParam(jspath1(b,"$.currentRecommendedPayment.value"),a,"accounts.recompay");getParam(jspath1(b,"$.currentMinimalPayment.value"),a,"accounts.minpay");getParam(jspath1(b,"$.duedate.milliseconds"),a,"accounts.minpay_till");getParam(jspath1(b,"$.marketingName"),a,"accounts.name");getParam(jspath1(b,"$.loyalty[0].amount"),a,"accounts.cashback");AnyBalance.isAvailable("accounts.transactions")&&processAccountsTransactions(a)}
