...
function processCard(b,a,c){AnyBalance.trace("Обработка карты "+c.__name);var d=jspath1(a,"$.moneyAmount")||jspath1(a,"$.accountBalance");getParam(jspath1(a,"$.accountBalance.value"),c,"cards.balance");getParam(jspath1(a,"$.moneyAmount.value"),c,"cards.available");getParam(jspath1(d,"$.currency.name"),c,"cards.currency");getParam(jspath1(b,"$.expiration.milliseconds"),c,"cards.till");getParam(jspath1(b,"$.activated"),c,"cards.active");getParam(jspath1(b,"$.primary"),c,"cards.primary");getParam(jspath1(b,
"$.reissued"),c,"cards.reissued");getParam(jspath1(b,"$.status"),c,"cards.status");getParam(jspath1(b,"$.statusCode"),c,"cards.status_code");getParam(jspath1(b,"$.name"),c,"cards.name");getParam(jspath1(a,"$.externalAccountNumber"),c,"cards.accnum");AnyBalance.isAvailable("cards.transactions")&&processCardsTransactions(c)}
