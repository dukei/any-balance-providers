...
getData();requestJson("warmup_cache",{},{post:joinObjects({old_session_id:a.oldSessionId,phone:a.oldSessionId?void 0:"+7"+b.login,deviceId:getDeviceId()},g_postParams)});loginByPin()||loginByPhone();__setLoginSuccessful()}return g_sessionid}
