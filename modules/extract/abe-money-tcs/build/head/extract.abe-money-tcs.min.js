var g_headers={"User-Agent":"OnePlus ONEPLUS A3010/android: 9/TCSMB/5.2.1"},g_currency={RUB:"₽",USD:"$",EUR:"€",BYN:"Br",KZT:"₸",GBP:"£",CNY:"Ұ",undefined:""},g_system={MR:"МИР",MIR:"МИР",VI:"VISA",VISA:"VISA",MC:"MasterCard",MASTERCARD:"MasterCard",undefined:""},g_baseurl="https://api.tinkoff.ru/v1/",g_sessionid,g_postParams={mobile_device_model:"ONEPLUS A3010",mobile_device_os:"android",appVersion:"5.2.1",screen_width:"1080",root_flag:"false",appName:"mobile",origin:"mobile,ib5,loyalty,platform",
deviceId:void 0,connectionType:"WiFi",platform:"android",screen_dpi:"420",mobile_device_os_version:"9",screen_height:"1920",fingerprint:"OnePlus ONEPLUS A3010/android: 9/TCSMB/5.2.1###1080x1920x32###180###false###false###"};
...
getParam(jspath1(b,"$.monthlyCashLimit.value"),a,"accounts.free_cash_left");getParam(jspath1(b,"$.renewalAmountLeft.value"),a,"accounts.free_add_left");getParam(jspath1(b,"$.rate"),a,"accounts.pct");getParam(jspath1(b,"$.status"),a,"accounts.status_code");getParam(jspath1(b,"$.creditLimit.value"),a,"accounts.limit");getParam(jspath1(b,"$.debtAmount.value"),a,"accounts.debt");getParam(jspath1(b,"$.currentRecommendedPayment.value"),a,"accounts.recompay");getParam(jspath1(b,"$.currentMinimalPayment.value"),
a,"accounts.minpay");getParam(jspath1(b,"$.duedate.milliseconds"),a,"accounts.minpay_till");getParam(jspath1(b,"$.marketingName"),a,"accounts.name");getParam(jspath1(b,"$.loyalty[0].amount"),a,"accounts.cashback");AnyBalance.isAvailable("accounts.transactions")&&processAccountsTransactions(a)}
