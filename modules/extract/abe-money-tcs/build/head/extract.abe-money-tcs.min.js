var g_headers={"User-Agent":"User-Agent: Sony D6503/android: 5.1.1/TCSMB/4.1.3"},g_baseurl="https://api.tinkoff.ru/v1/",g_deviceid,g_sessionid;
function requestJson(b,a,c){var d=[];c||(c={});g_sessionid&&d.push(encodeURIComponent("sessionid")+"="+encodeURIComponent(g_sessionid));if(a)for(var e in a)d.push(encodeURIComponent(e)+"="+encodeURIComponent(a[e]));d.push(encodeURIComponent("appVersion")+"="+encodeURIComponent("4.1.3"));d.push(encodeURIComponent("platform")+"="+encodeURIComponent("android"));d.push(encodeURIComponent("origin")+"="+encodeURIComponent("mobile,ib5,loyalty,platform"));d.push(encodeURIComponent("connectionType")+"="+encodeURIComponent("WiFi"));
g_deviceid&&d.push(encodeURIComponent("deviceId")+"="+encodeURIComponent(g_deviceid));a=c.post?AnyBalance.requestPost(g_baseurl+b+"?"+d.join("&"),c.post,g_headers):AnyBalance.requestGet(g_baseurl+b+"?"+d.join("&"),g_headers);a=getJson(a);if("OK"!=a.resultCode&&!c.noException)throw AnyBalance.trace("Ошибка: "+b+", "+a.errorMessage),new AnyBalance.Error((c.scope?c.scope+": ":"")+(a.plainMessage||a.errorMessage));return a}var g_accountsJson,g_accountTransactions={};
function requestAccountsJson(){g_accountsJson||(g_accountsJson=requestJson("accounts_flat"));return g_accountsJson}
