var g_headers={"User-Agent":"OnePlus ONEPLUS A3010/android: 9/TCSMB/5.2.1"},g_currency={RUB:"₽",USD:"$",EUR:"€",BYN:"Br",KZT:"₸",GBP:"£",CNY:"Ұ",undefined:""},g_baseurl="https://api.tinkoff.ru/v1/",g_sessionid,g_postParams={mobile_device_model:"ONEPLUS A3010",mobile_device_os:"android",appVersion:"5.2.1",screen_width:"1080",root_flag:"false",appName:"mobile",origin:"mobile,ib5,loyalty,platform",deviceId:void 0,connectionType:"WiFi",platform:"android",screen_dpi:"420",mobile_device_os_version:"9",
screen_height:"1920",fingerprint:"OnePlus ONEPLUS A3010/android: 9/TCSMB/5.2.1###1080x1920x32###180###false###false###"};
...
getParam(jspath1(b,"$.accountGroup"),a,"accounts.type");getParam(jspath1(b,"$.accountType"),a,"accounts.type_code");getParam(jspath1(b,"$.authorizationsAmount.value"),a,"accounts.blocked");getParam(jspath1(b,"$.defaultMonthlyCashLimit.value"),a,"accounts.free_cash_limit");getParam(jspath1(b,"$.defaultRenewalAmountLeft.value"),a,"accounts.free_add_limit");getParam(jspath1(b,"$.monthlyCashLimit.value"),a,"accounts.free_cash_left");getParam(jspath1(b,"$.renewalAmountLeft.value"),a,"accounts.free_add_left");
getParam(jspath1(b,"$.rate"),a,"accounts.pct");getParam(jspath1(b,"$.status"),a,"accounts.status_code");getParam(jspath1(b,"$.creditLimit.value"),a,"accounts.limit");getParam(jspath1(b,"$.debtAmount.value"),a,"accounts.debt");getParam(jspath1(b,"$.currentRecommendedPayment.value"),a,"accounts.recompay");getParam(jspath1(b,"$.currentMinimalPayment.value"),a,"accounts.minpay");getParam(jspath1(b,"$.duedate.milliseconds"),a,"accounts.minpay_till");getParam(jspath1(b,"$.marketingName"),a,"accounts.name");
getParam(jspath1(b,"$.loyalty[0].amount"),a,"accounts.cashback");AnyBalance.isAvailable("accounts.transactions")&&processAccountsTransactions(a)}
...
function processSaving(b,a){AnyBalance.trace("Обработка накопительного счета "+a.__name);getParam(jspath1(b,"$.accountType"),a,"savings.type_code");getParam(jspath1(b,"$.marketingName"),a,"savings.name");getParam(jspath1(b,"$.creationDate.milliseconds"),a,"savings.date_start");getParam(jspath1(b,"$.interest.value"),a,"savings.pct_sum");getParam(jspath1(b,"$.tariffInfo.interestRate")||jspath1(b,"$.rate"),a,"savings.pct");getParam(jspath1(b,"$.accountBalance.value"),a,["savings.balance","savings.currency"]);
getParam(jspath1(b,"$.moneyAmount.value"),a,["savings.available","savings.currency"]);getParam(g_currency[jspath1(b,"$.moneyAmount.currency.name")]||jspath1(b,"$.moneyAmount.currency.name"),a,["savings.currency","savings.balance"]);getParam(jspath1(b,"$.status"),a,"savings.status_code");AnyBalance.isAvailable("savings.transactions")&&processSavingsTransactions(a)}function findAccountById(b){for(var a=requestAccountsJson(),c=0;c<a.payload.length;c++){var d=a.payload[c];if(d.id==b)return d}}
