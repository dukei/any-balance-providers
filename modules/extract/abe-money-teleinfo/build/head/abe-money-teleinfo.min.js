...
function deserialize(a){try{var b=function(a,b,c){if("list"==h)f.push(b(a));else if("map"==h)if(g)f[g]=b(a),g=null;else if(c)g=a;else throw new AnyBalance.Error("deserialize error: unexpected property without name: <"+elem+">"+a);else throw new AnyBalance.Error("deserialize error: unexpected value outside the container: <"+elem+">"+a);},c=new EasySAXParser,d=[],e=[],g=null,h=null,f=null,m=null,k=[],n=0;c.on("error",function(a){AnyBalance.trace(a)});c.on("startNode",function(a,b,c,p,q){m="";switch(a){case "map":f=
{};break;case "list":f=[];break;default:return}k[n++]=f;d.push(f);e.push(g);g=null;h=a});c.on("endNode",function(a,c,n,p){c=m;switch(a){case "type":f.__type=c;break;case "length":if("list"!=h)throw new AnyBalance.Error("deserialize error: unexpected length outside list: <"+a+">"+c);break;case "string":b(c,function(a){return a},!0);break;case "boolean":b(c,function(a){return"true"==a.toLowerCase()||"1"==a});break;case "null":b(c,function(a){return null});break;case "double":b(c,function(a){return parseFloat(a)});
...
a+"> "+b);return d});break;case "map":case "list":c=d.pop();g=e.pop();0<d.length&&(f=d[d.length-1],h=isArray(f)?"list":"map","map"==h?f[g]=c:f.push(c),g=null);break;case "ref":b(c,function(a){a=parseInt(a,10);if(!k[a])throw new AnyBalance.Error("Inexistent reference: "+a+" of "+k.length);return k[a]});break;default:throw new AnyBalance.Error("deserialize error: unexpected tag: <"+a+">"+c);}});c.on("textNode",function(a,b){m=b(a)});c.parse(a);return f}catch(l){throw AnyBalance.trace("Error unserializing xml: "+
