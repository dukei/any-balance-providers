...
function request(a){var b="<map>"+serialize(a)+"</map>";AnyBalance.trace("Requesting "+getParam(a.payload.__type,null,null,/\.(\w+)$/));var c=CryptoJS.enc.Utf8.parse(b);a=CryptoJS.enc.Utf8.parse("2.6.0");var d=new CryptoJS.lib.WordArray.init([c.sigBytes+a.sigBytes+1,a.sigBytes<<24],5),e=d.sigBytes;d.concat(a).concat(c);c=AnyBalance.requestPost("https://mb.vtb24.ru/mobilebanking/burlap/",CryptoJS.enc.Base64.stringify(d),{"mb-protocol-version":"2.6.0","mb-app-version":"0.1.46",Connection:"Keep-Alive"});
