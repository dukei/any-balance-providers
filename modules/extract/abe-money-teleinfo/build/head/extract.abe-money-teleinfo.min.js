...
function deserialize(a){try{var b=function(a,b,d){if("list"==f)h.push(b(a));else if("map"==f)if(g)h[g]=b(a),g=null;else if(d)g=a;else throw new AnyBalance.Error("deserialize error: unexpected property without name: <"+elem+">"+a);else throw new AnyBalance.Error("deserialize error: unexpected value outside the container: <"+elem+">"+a);},c=new EasySAXParser,d=[],e=[],g=null,f=null,h=null,m=null,k=[],n=0;c.on("error",function(a){AnyBalance.trace(a)});c.on("startNode",function(a,b,c,p,q){m="";switch(a){case "map":h=
{};break;case "list":h=[];break;default:return}k[n++]=h;d.push(h);e.push(g);g=null;f=a});c.on("endNode",function(a,c,n,p){c=m;switch(a){case "type":h.__type=c;break;case "length":if("list"!=f)throw new AnyBalance.Error("deserialize error: unexpected length outside list: <"+a+">"+c);break;case "string":b(c,function(a){return a},!0);break;case "boolean":b(c,function(a){return"true"==a.toLowerCase()||"1"==a});break;case "null":b(c,function(a){return null});break;case "double":b(c,function(a){return parseFloat(a)});
...
function getCardsAndAccounts(){function a(d){for(var g=0;d&&g<d.length;g++){var f=d[g];c[f.id]||(b.payload.products.push(f),c[f.id]=f,a(f.masterAccountCards),a(f.cards),a(f.cardAccount&&[f.cardAccount]),a(f.mainCard&&[f.mainCard]))}}if(g_cardsAndAccounts)return g_cardsAndAccounts;var b=request(new Message({__type:"ru.vtb24.mobilebanking.protocol.product.PortfolioRequest",refreshImmediately:!0,portfolioType:{__type:"ru.vtb24.mobilebanking.protocol.product.PortfolioTypeMto",id:"ACCOUNTS_AND_CARDS"}},
null,g_commonProperties));b.payload.products=[];for(var c={},d=0;d<b.payload.portfolio.productGroups.length;++d)a(b.payload.portfolio.productGroups[d].items);AnyBalance.trace("Найдено "+b.payload.products.length+" карт и счетов");return g_cardsAndAccounts=b}
