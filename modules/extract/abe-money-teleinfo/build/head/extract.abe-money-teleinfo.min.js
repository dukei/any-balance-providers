...
function request(a){var b="<map>"+serialize(a)+"</map>";AnyBalance.trace("Requesting "+getParam(a.payload.__type,null,null,/\.(\w+)$/));var c=CryptoJS.enc.Utf8.parse(b);a=CryptoJS.enc.Utf8.parse("2.28.1");var d=new CryptoJS.lib.WordArray.init([c.sigBytes+a.sigBytes+1,a.sigBytes<<24],5),e=d.sigBytes;d.concat(a).concat(c);c=AnyBalance.requestPost("https://mb.vtb24.ru/mobilebanking/burlap/",CryptoJS.enc.Base64.stringify(d),{"mb-protocol-version":"2.28.1","mb-app-version":"0.1.46",Connection:"Keep-Alive"});
...
function getCardsAndAccounts(){function a(d){for(var e=0;d&&e<d.length;e++){var f=d[e];c[f.id]||(b.payload.products.push(f),c[f.id]=f,a(f.masterAccountCards),a(f.cards),a(f.cardAccount&&[f.cardAccount]),a(f.mainCard&&[f.mainCard]))}}if(g_cardsAndAccounts)return g_cardsAndAccounts;var b=request(new Message({__type:"ru.vtb24.mobilebanking.protocol.product.PortfolioRequest",refreshImmediately:!0,portfolioType:{__type:"ru.vtb24.mobilebanking.protocol.product.PortfolioTypeMto",id:"ACCOUNTS_AND_CARDS"}},
null,g_commonProperties));b.payload.products=[];for(var c={},d=0;d<b.payload.portfolios.length;++d)for(var e=b.payload.portfolios[d],g=0;g<e.productGroups.length;++g){var k=e.productGroups[g];a(k.mainProduct&&[k.mainProduct]);a(k.products)}AnyBalance.trace("Найдено "+b.payload.products.length+" карт и счетов");return g_cardsAndAccounts=b}
...
id:a.id,type:a.__type}},null,g_commonProperties));c.lastOperationDate&&getParam(c.lastOperationDate.getTime(),b,"accounts.last_op_date")}AnyBalance.isAvailable("accounts.transactions")&&processAccountTransactions(a,b)}
