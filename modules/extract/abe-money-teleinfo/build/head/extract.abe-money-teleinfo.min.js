function trace(a){AnyBalance.trace(stringifyCircular(a))}function stringifyCircular(a){var b=[];return JSON.stringify(a,function(a,d){if("object"===typeof d&&null!==d){a=b.indexOf(d);if(-1!==a)return a;d.__reference__id=b.length;b.push(d)}return d})}
...
b,"cards.date_start");getParam(a.brandName,b,"cards.ps");getParam(a.coBrandName,b,"cards.cobrand");getParam(a.isEmitedForOwner,b,"cards.for_owner");getParam(a.isMain,b,"cards.is_main");getParam(a.status.id,b,"cards.status");if(/Credit/.test(a.__type)&&AnyBalance.isAvailable("cards.limit","cards.pct","cards.minpay","cards.gracepay","cards.credit_till","cards.minpay_till","cards.grace_till")){var c=request(new Message({__type:"ru.vtb24.mobilebanking.protocol.ObjectRequest",identity:{__type:"ru.vtb24.mobilebanking.protocol.ObjectIdentityMto",
id:a.id,type:a.__type}},null,g_commonProperties)).payload.cardAccount,d=c&&c.loanInfo;c&&null!=c.creditLimit&&getParam(c.creditLimit,b,"cards.limit");d&&(null!=d.interestRate&&getParam(d.interestRate,b,"cards.pct"),null!=d.minAmountForRepayment&&getParam(d.minAmountForRepayment,b,"cards.minpay"),null!=d.graceAmountForRepayment&&getParam(d.graceAmountForRepayment,b,"cards.gracepay"),d.limitEndDate&&getParam(d.limitEndDate.getTime(),b,"cards.credit_till"),d.repaymentDate&&getParam(d.repaymentDate.getTime(),
b,"cards.minpay_till"),d.graceEndDate&&getParam(d.graceEndDate.getTime(),b,"cards.grace_till"))}AnyBalance.isAvailable("cards.transactions")&&processCardTransactions(a,b)}
