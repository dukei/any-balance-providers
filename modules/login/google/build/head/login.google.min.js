...
a),c,addHeaders({Referer:AnyBalance.getLastUrl()}))}h(a);if(b=getElement(a,/<form[^>]+action="SmsAuthInterstitial"[^>]*>/i))AnyBalance.trace("Needs 2-factor parameters review, skipping it to view later"),c=createFormParams(a,function(a,b,c,d){if(!/type="submit"/i.test(b)||"remind"==c)return d}),a=AnyBalance.requestPost("https://accounts.google.com/SmsAuthInterstitial",c,addHeaders({Referer:AnyBalance.getLastUrl()}));h(a)}AnyBalance.saveCookies();AnyBalance.saveData();return a};
