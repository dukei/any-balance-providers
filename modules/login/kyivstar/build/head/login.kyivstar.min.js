...
function loadAuthorizationPage(a){clearAllCookies();return AnyBalance.requestGet("https://account.kyivstar.ua/cas/login?"+a,g_headers)}function goToOldSite(a){/<a[^>]+new.kyivstar.ua[^>]+ks-button|FMK2.do/i.test(a)&&(AnyBalance.trace("Новый лк или его реклама, переходим на старый"),a=AnyBalance.requestGet("https://account.kyivstar.ua/cas/login?service=http%3A%2F%2Fmy.kyivstar.ua%3A80%2Ftbmb%2FMK2.do",g_headers));return a}
