...
function isLoggedIn(a){return/\/tbmb\/logout\/perform/i.test(a)||isLoggedInNew(a)}function isLoggedInNew(a){return/var\s+pageData\s*=/.test(a)||/new.kyivstar.ua\/ecare\//i.test(a)}function checkGwtError(a){try{return gwtGetJSON(a)}catch(d){if(/accountNotFound|AccountException/i.test(d.message))throw new AnyBalance.Error("Пользователь с таким логином не найден!",null,!0);throw d;}}
