...
function loginByPassword(prefs){
	...
	var solve=solveRecaptcha("Пожалуйста, докажите, что Вы не робот",'https://rivegauche.ru/my-account', '6Lc1JKUZAAAAAMk0jBpSvm_WFs9hi9bgsisdcYBE')
	var html = AnyBalance.requestPost(baseurl+'oauth2/acquire-token',JSON.stringify({
		"username": prefs.login,
		"password": prefs.password,
		"rememberMe": true,
		"reCaptchaResponse": solve	
		}), g_headers);
