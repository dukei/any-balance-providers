...
function apiNew() {
    ...
    g_geaders['user-agent-mob'] = '{"appVersion":"7.04.02","biometric":false,"brand":"OnePlus","deviceModel":"ONEPLUS A5000|OnePlus","display":"ONEPLUS A5000_23_171031","firstInitTime":"' + data.firstInitTime + '","hardware":"qcom","imeiGenerate":"' + data.imei + '","industrialName":"OnePlus5","isRooted":false,"lang":"' + (prefs.lang | 'ru') + '","lat":"0.0","lng":"0.0","model":"ONEPLUS A5000","modelType":"Tablet","nfcHce":true,"osName":"AOS","osVersion":"13"}';
    if (data.token) {
