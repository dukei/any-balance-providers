...
function main(){
    ...
    getParam(html, result, 'trafficIn', /<strong>Входящий<\/strong>[\s\S]*?<td[^>]*>([^<]*)/i, replaceTagsAndSpaces, parseTraffic);
    getParam(html, result, 'trafficOut', /<strong>Исходящий<\/strong>[\s\S]*?<td[^>]*>([^<]*)/i, replaceTagsAndSpaces, parseTraffic);
