...
var g_lks = {
    pesc: 'http://ikus.pesc.ru:8080/IKUSUser/',
    pes: 'https://ikus.pes.spb.ru/IKUSUser/'
}

function main(){
    var prefs = AnyBalance.getPreferences();

    var baseurl = !prefs.type || !g_lks[prefs.type] ? g_lks.pesc : g_lks[prefs.type];
    ...
    html = AnyBalance.requestPost(baseurl + "application.auth", 
        "6|0|7|" + baseurl + "gwt/personalAccountAuth/|82CA86D7466828F87336B012396E3F69|com.sigma.personal.auth.AuthService|login|java.lang.String/2004016611|" + gwtEscape(prefs.login) + "|" + gwtEscape(prefs.password) + "|1|2|3|4|2|5|5|6|7|",
        { 
...
//          'Accept-Charset': 'windows-1251,utf-8;q=0.7,*;q=0.3'
    ...
    html = AnyBalance.requestPost(baseurl + 'com.sigma.personal.client.ClientService.gwt',
        "6|0|4|" + baseurl + "gwt/personalAccount/|82133025EC649C66FFD6B00CF20FDAA9|com.sigma.personal.client.ClientService|getAbonsList|1|2|3|4|0|",
        { 
          'Content-Type': 'text/x-gwt-rpc; charset=UTF-8', 
